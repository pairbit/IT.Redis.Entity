...
public static class Int16Utf8Formatter
{
    public class Var : IUtf8Formatter<Int16>
    {
        public static readonly Var Default = new();

        public int GetLength(in short value)
        {
        ...
        public bool TryFormat(in short value, Span<byte> span, out int written)
        {
            if (value < 0) throw new ArgumentOutOfRangeException(nameof(value));
    ...
    public class Fixed : IUtf8Formatter<Int16>
    {
        ...
        public int GetLength(in short value)
        {
            if (value < 0 || value > MaxValue.Int16(_length)) throw new ArgumentOutOfRangeException(nameof(value));
