...
public static class SByteUtf8Formatter
{
    public class Var : IUtf8Formatter<sbyte>
    {
        public static readonly Var Default = new();

        public int GetLength(in sbyte value)
        {
        ...
        public bool TryFormat(in sbyte value, Span<byte> span, out int written)
        {
            if (value < 0) throw new ArgumentOutOfRangeException(nameof(value));
    ...
    public class Fixed : IUtf8Formatter<sbyte>
    {
        ...
        public int GetLength(in sbyte value)
        {
            if (value < 0 || value > MaxValue.SByte(_length)) throw new ArgumentOutOfRangeException(nameof(value));
